...
import com.yb.part5_chapter03.adapter.ImageViewPagerAdapter
import com.yb.part5_chapter03.databinding.ActivityImageListBinding
        ...
        imageViewPager.registerOnPageChangeCallback(object : ViewPager2.OnPageChangeCallback() {
            override fun onPageSelected(position: Int) {
                ...
                toolbar.title = if (imageViewPagerAdapter.uriList.isNotEmpty()) {
                    ...
                    getString(R.string.images_page,
                        position + 1,
